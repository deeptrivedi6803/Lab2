...
/**
 * A simple client that requests Poll Service.
 */
public class PollClient {
    ...
    private final PollServiceStub clientStub;
    ...
    public PollClient(String host, int port) {
        ...
        clientStub = PollServiceGrpc.newStub(channel);
    }
    ...
    public void addPollService(String moderatorId, String question, String startedAt, String expiredAt, String[] choice) {
        try {
            logger.info("Will try to create new poll for moderator " + moderatorId);
